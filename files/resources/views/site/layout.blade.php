...
<head>
    ...
    <title>Интернет магазин BabyFox</title>
        ...
        <nav class="side-navbar">
          ...
          {{--  <span class="heading">Main</span>--}}
            <ul class="list-unstyled">
                <li class="active"><a href="{{url('categories')}}"><i class="fa fa-list"></i></i>Категории</a></li>
                <li class="active"><a href="{{url('products')}}"><i class="fa fa-list"></i></i>Продукты</a></li>
